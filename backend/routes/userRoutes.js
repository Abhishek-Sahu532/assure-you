...
const {registerUser, loginUser,forgetPassword, logOut, resetPassword, getUserDetails, updatePassword, updateProfile, getAllUser, getSingleUserDetail, updateUserRole, deleteUser} = require('../controllers/userController')
