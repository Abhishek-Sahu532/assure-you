                    ...
                    <div className="orderDetailsPage">
                        <div className="orderDetailsContainer">
                            ...
                            <div className="orderDetailsContainerBox">
                                ...
                                <div>
                                    <p>Address :</p>
                                    <span>{order.shippingInfo.address && `${order.shippingInfo.address}, ${order.shippingInfo.city}, ${order.shippingInfo.state}, ${order.shippingInfo.pincode}, ${order.shippingInfo.country}`}</span>
                                </div>
                            </div>
                        ...
                        <div className="orderDetailsCartItems">
                            ...
                            <div className="orderDetailsCartItesmContainer">
