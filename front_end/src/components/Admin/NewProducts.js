...
<div>
    <DescriptionIcon />
  <textarea placeholder="Product Description" value={description} onChange={(e)=> setDescription(e.target.value) } cols='30' rows=''  ></textarea>
</div>
<div>
    <AccountTreeIcon />
...
<Button id="createProductBtn" type="submit" disable={loading ? true : false} >Create</Button>
